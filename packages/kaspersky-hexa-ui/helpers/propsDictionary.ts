/**
 * Design/prototype props dictionary.
 *
 * This file is a normalized glossary for Storybook, UXPin and agent workflows.
 * It is not the source of truth over public component TypeScript props.
 */
...
export const propsDictionary = {
  ...
  disabled: {
    ...
    type: 'boolean',
    description:
      'Компонент недоступен для взаимодействия, визуально приглушен. Скринридеры объявляют элемент как unavailable',
    category: 'component'
  },
  ...
  readonly: {
    ...
    type: 'boolean',
    description:
      'Значение доступно для просмотра, но не для редактирования. В отличие от disabled, элемент остается в фокусе и читается скринридерами',
    category: 'component'
  },
  ...
  expanded: {
    ...
    type: 'boolean',
    description:
      'Компонент развернут. Управляет раскрытым/свернутым состоянием disclosure-элементов',
    category: 'component'
  },
  ...
  notification: {
    ...
    type: 'boolean',
    description:
      'Показывает или скрывает вложенный компонент уведомления. В коде передается ReactNode с нужным вариантом уведомления',
    category: 'visibility'
  },
  ...
  clearable: {
    ...
    type: 'boolean',
    description:
      'Показывает кнопку очистки значения внутри инпута. При нажатии сбрасывает введенный текст',
    category: 'component'
  },
